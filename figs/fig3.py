...
q_wn, wn_sin, wn_sn, a_sin, a_sn, a_0 = np.loadtxt(
                        'data-fig3ab.txt', delimiter=',', skiprows=1, unpack=1)

q_cp, cpt_sin, cpt_sn = np.loadtxt('data-fig3c.txt', delimiter=',', skiprows=1, unpack=1)
